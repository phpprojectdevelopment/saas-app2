...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2020 at 04:12 PM
...
INSERT INTO `users` (`id`, `name`, `email_id`, `mobile_no`, `birthday`, `gender`, `state_id`, `city_id`, `profile_photo`, `skill`, `upload_certificates`, `profession`, `company_name`, `job_started_from`, `business_name`, `location`, `created_at`, `updated_at`) VALUES
(1, 'Samir Gupta', 'samir.gupta@gmail.com', '9930678900', NULL, 'male', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Malad', NULL, NULL),
(2, 'abhijit lakule', 'abhijit.lakule@gmail.com', '8930678921', NULL, 'female', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Goregaon east', NULL, '2020-06-29 08:34:08'),
(3, 'Deepak Kumar', 'deepak.kumar@gmail.com', '9830678921', NULL, 'male', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Malad', NULL, NULL),
(4, 'Keval Patel', 'keval.patel@gmail.com', '9730678931', NULL, 'male', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Malad', NULL, NULL),
(5, 'Sahil Joshi', 'sahil.joshi@gmail.com', '9630678941', NULL, 'male', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Malad', NULL, NULL);
...
ALTER TABLE `users`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uc_email` (`email_id`),
  ADD UNIQUE KEY `uc_mobile` (`mobile_no`);
